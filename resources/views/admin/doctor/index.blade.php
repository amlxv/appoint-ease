...
@section('x-content')
    <x-layouts.user-table title="Doctors" description="A list of all the registered doctors in the system."
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <div class="text-gray-500">
                                    <span
                                        class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 {{ $user->doctor->status == 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}}">{{ $user->doctor->status == 'active' ? 'Available' : 'Not Available' }}</span>
                                        </div>
                                    </td>
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-sm font-medium sm:pr-6">
                                        <a href="{{ route('doctors.edit', $user->doctor->id) }}"
